...
function lib:init(ti, dosplash, visiblekey, deleteprevious)
    ...
    if dosplash then
        ...
        splash.BackgroundColor3 = Color3.fromRGB(30, 31, 34)
        ...
        sicon.ZIndex = 40
        sicon.Image = "rbxassetid://130206672959803"
        ...
        sshadow.ZIndex = 39
        sshadow.Image = "rbxassetid://130206672959803"
    ...
    main.BackgroundColor3 = Color3.fromRGB(32, 34, 38)
